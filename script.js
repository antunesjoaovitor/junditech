...
botaoEnviar.addEventListener("click", async () => {
  ...
  try {
    const resposta = await fetch("https://https://examination-mhz-latitude-corps.trycloudflare.com-indices-pursuit-homework.trycloudflare.com/webhook/e9ca83ba-8966-4b95-bc42-203c31b4324a", {
      method: "POST",
      headers: {
